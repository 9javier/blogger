...
import {BlogRepository, DepartamentRepository} from '../repositories';
...
export class BlogController {
  constructor(
    ...
    public deptRepository:DepartamentRepository,
  ...
  async findByIdDept(
    ...
    return this.blogRepository.find({where:{id_departament: `${id}`}});
  }
